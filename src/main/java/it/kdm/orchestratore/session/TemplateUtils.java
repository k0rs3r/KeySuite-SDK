...
public class TemplateUtils {
    ...
    public TemplateUtils(){
        try {
            this.messageSource = (MessageSource) KDMUtils.getBean("messageSource");
        } catch (Exception e) {
    ...
    public Object getBean(String bean){
        return it.kdm.orchestratore.utils.KDMUtils.getBean(bean);
    }

    public KDMUtils getKdmUtils(){
        return new KDMUtils();
    }
    ...
    public PropertyResolver getEnv(){ return ApplicationProperties.getEnv(); };
    ...
    public String ftl(String tmpl, Map<String,Object> buffer){
        try {
            if (!buffer.containsKey("sede")){
                ...
                buffer.put("sede", ToolkitConnector.getSedeLocale());
            }

            return KDMUtils.ftlHandler(tmpl, buffer);
...
*/
    ...
    public static String getProperty(String property, String def){
        return ApplicationProperties.getEnv().getProperty(property,def);
    }

    public static NodeModel parseXml(String xmlStr){
        try {
            return freemarker.ext.dom.NodeModel.parse(new InputSource(new StringReader(xmlStr)));
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
