...
public class ResourceUtils {
    ...
    public static String getResourceRoot(String sub){
        ...
        if (Strings.isNullOrEmpty(sub) || sub.equals(RESOURCES)) {
            path = System.getProperty(RESOURCES,Utils.getConfigHome()+"/"+RESOURCES);
        ...
        if (path!=null && path.startsWith("./")) {
            String def = System.getProperty(RESOURCES,Utils.getConfigHome()+"/"+RESOURCES);
    ...
    public static String getResourceETag(String resource,InputStream stream) throws FileNotFoundException{
        if (builtTime==null){
            BuildProperties bp = (BuildProperties) KDMUtils.getBean("buildProperties");
        ...
        if (request!=null && "true".equals(request.getParameter("export"))){
            ...
            if (!resFile.exists()){
                try{
                    ...
                    if (resource.toLowerCase().endsWith(".ftl")){
                        TemplateLoader tl = KDMUtils.getFTLConfiguration().getTemplateLoader();
                    ...
                    initialStream = new FileInputStream(resFile);
