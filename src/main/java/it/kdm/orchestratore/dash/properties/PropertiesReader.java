package it.kdm.orchestratore.dash.properties;
...
public final class PropertiesReader {
    ...
    private InputStream getInputStreamApp() {
        return findResource("AppHome.properties");
    }
...
//        return global.getProperty("attach.dir");
    ...
    public String getProperty(String key){
        String res = "";
        try{
            res = ApplicationProperties.getInstance("AppHome.properties").getPropertyByKey(key, "");
        }catch (Exception w){
            w.printStackTrace();
        }
    ...
    public String getRedirectUrlFormat(String objType){
        String name = objType + ".redirectUrlFormat";
        return getProperty(name);
//        return properties.getProperty(name);
    }

    public String getWidget1Url(){
        return getProperty("widget1");
//        return properties.getProperty("widget1");
    }

    public String getWidget2Url(){
        return getProperty("widget2");
//        return properties.getProperty("widget2");
    }

    public String getWidget3Url(){
        return getProperty("widget3");
//        return properties.getProperty("widget3");
    }

    public String getWidget4Url(){
        return getProperty("widget4");
//        return properties.getProperty("widget4");
    }
